...
namespace TestClient.Library.Algorithms
{
    /// <summary>
    ...
    {
        public struct HungarianAlgorithmInput
        {
            public int Source; 
        ...
        private HungarianAlgorithmInput findMinSlack()
        {
            var minSlackDest = -1;
            ...
            return new HungarianAlgorithmInput() { Source= minSlackSource, Destination= minSlackDest, Value=minSlackValue};
        }
